...
export default function SearchProperty() {
  ...
  const loadProperties = async () => {
    try {
      ...
      const propertyList = Array.isArray(response?.properties)
        ? response.properties
        : [];
  ...
  const toggleFavorite = async (propertyId) => {
    if (!propertyId || favoriteLoading[propertyId]) {
      return;
    }
  ...
  const getLocation = (property) => {
    ...
    return parts.length > 0
      ? parts.join(", ")
      : location.region || "Location not available";
  };
  ...
  const getImage = (property) => {
    const media = getMediaAsset(property);
    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-6 space-y-6 bg-gradient-to-br from-slate-50 via-white to-amber-50/20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#022036]/50 font-medium">
              Find your perfect home from approved
              rental properties
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b-2 border-black/10">
            <div>
              <span className="text-[10px] tracking-widest uppercase font-black text-[#FFC107]">
                FILTER
              </span>

              <h2 className="text-sm font-black text-[#022036]">
                Search Filters
              </h2>
            </div>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-[#022036]/70 uppercase tracking-wider">
              Category
            </label>
            ...
            <div className="relative">
              <Home
                size={15}
                className="absolute left-3.5 top-3 text-[#FFC107]"
              />
              ...
              <ChevronDown
                size={14}
                className="absolute right-3.5 top-3.5 text-[#022036]/40 pointer-events-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#022036]/40 font-black">
                —
              </span>
        ...
        <main className="lg:col-span-3 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white border-2 border-black/10 p-4 rounded-2xl shadow-sm">
            <div>
              ...
              <p className="text-[10px] text-[#022036]/50 mt-0.5">
                <strong className="text-[#FFC107] font-bold">
                  {totalProperties}
                </strong>{" "}
                properties found
              </p>
            ...
            <div className="flex items-center gap-2">
              <label className="text-[10px] text-[#022036]/50 font-black uppercase tracking-wider">
                Sort:
              </label>
              ...
              <div className="relative">
                ...
                <ChevronDown
                  size={13}
                  className="absolute right-2.5 top-2.5 text-[#022036]/40 pointer-events-none"
                />
              </div>
            </div>
          </div>
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20 gap-4 bg-white border-2 border-black/10 rounded-2xl">
              ...
              <h3 className="text-sm font-black text-[#022036]">
                Loading properties...
              </h3>

              <p className="text-xs text-[#022036]/40">
                Finding available homes for you.
              </p>
            </div>
          )}
          ...
          {!loading && error && (
            <div className="flex flex-col items-center justify-center text-center py-16 px-6 bg-rose-50 border-2 border-rose-200 rounded-2xl">
              ...
              <h3 className="text-base font-black text-[#022036] mb-1">
                Unable to load properties
              </h3>

              <p className="text-rose-700 text-xs max-w-md mb-6 font-semibold">
                {error}
              </p>
          ...
          {!loading &&
            ...
            properties.length === 0 && (
              <div className="flex flex-col items-center justify-center text-center py-20 px-6 bg-white border-2 border-black/10 rounded-2xl">
                ...
                <h3 className="text-lg font-black text-[#022036] mb-1">
                  No properties found
                </h3>

                <p className="text-xs text-[#022036]/40 max-w-xs mb-6 font-light">
                  Try changing your search keywords
                  or active filter options.
                </p>
                    ...
                    >
                        ...
                        "video" ? (
                          <div className="relative w-full h-full bg-black">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                              <div className="w-11 h-11 rounded-full bg-black/60 backdrop-blur-sm text-[#FFC107] flex items-center justify-center border border-white/20 shadow-lg">
                                <Play
                                  size={17}
                                  fill="currentColor"
                                />
                      ...
                      <div className="p-4 flex flex-col flex-1 justify-between">
                        <div>
                          ...
                          <h3 className="font-black text-[#022036] text-sm mb-0.5 truncate">
                            {getTitle(property)}
                          </h3>
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div>
                              ...
                              <span className="text-[8px] text-[#022036]/40 block font-semibold">
                                Birr / month
                              </span>
                            </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-white border-2 border-black/10 rounded-xl p-3.5 flex items-center gap-3">
          ...
          <div>
            <p className="text-[8px] font-black uppercase tracking-wider text-black/40">
              Total Properties
            </p>
