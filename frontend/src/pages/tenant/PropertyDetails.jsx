...
export default function PropertyDetails() {
    ...
    const loadPropertyAndFavorites = async () => {
      try {
        ...
        const isFav = favList.some(
          (item) =>
            String(
              item?.propertyId || item?.property?.id || item?.id
            ) === String(id)
        );
    ...
    return (
      <div className="min-h-screen bg-slate-50 text-slate-800 flex items-center justify-center p-4 font-sans">
        <div className="bg-white border border-slate-200 rounded-2xl p-8 max-w-md w-full text-center shadow-xs">
          ...
          <h2 className="text-xl font-black text-[#022036] mb-2">
  ...
  const handleRentRequest = async (e) => {
    ...
    try {
      ...
      setRequestSuccess(
        "Rental request submitted successfully! Your request is now pending review."
      );
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 py-10 px-4 sm:px-8 relative overflow-y-auto font-sans selection:bg-yellow-500 selection:text-[#022036]">
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-slate-200">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-[#022036]">
              {title}
            </h1>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs flex flex-col justify-between">
            <div>
              ...
              {!isAvailable ? (
                <button
                  type="button"
                  className="w-full py-4 bg-slate-100 text-slate-400 font-bold rounded-2xl cursor-not-allowed text-xs uppercase tracking-wider"
                  disabled
                >
                ...
                <button
                  type="button"
                  className="w-full py-4 bg-amber-50 text-amber-800 font-extrabold rounded-2xl cursor-not-allowed text-xs uppercase tracking-wider flex items-center justify-center gap-2 border border-amber-200 shadow-xs"
                  disabled
                >
                  <CheckCircle size={18} />
                  Request Pending
                ...
                <button
                  type="button"
                  className="w-full py-4 bg-emerald-50 text-emerald-800 font-extrabold rounded-2xl cursor-not-allowed text-xs uppercase tracking-wider flex items-center justify-center gap-2 border border-emerald-200 shadow-xs"
                  disabled
                >
                  <CheckCircle size={18} />
                  Rental Approved
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs">
              <h2 className="text-lg font-black text-[#022036] mb-6 uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 shadow-xs">
                  ...
                  <strong className="text-base font-extrabold text-slate-900 truncate block">
                    {categoryName}
                  </strong>
                </div>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs">
              <h2 className="text-lg font-black text-[#022036] mb-4 uppercase tracking-wider">
                Description
              </h2>
      ...
      {showRequestForm && (
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white border border-slate-200 rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl relative my-8 text-slate-900 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start pb-4 mb-6 border-b border-slate-100">
              <div>
                <h2 className="text-xl font-black text-[#022036] uppercase tracking-wider">
                  Request to Rent
                </h2>
                ...
                <p className="text-xs text-slate-500 mt-1 font-light">
                  Submit agreement
                  application for:{" "}
                  <strong className="text-yellow-600 font-bold">
                    {title}
                  </strong>
                </p>
              </div>
