...
export default function CreateProperty() {
  ...
  // ============================================================
  // HOUSE DIMENSIONS + OWNERSHIP DOCUMENT
  // ============================================================
  ...
  const loadData = async () => {
    try {
      ...
      if (idNumber) {
        setIdNumberInput(String(idNumber));
      }
    } catch (err) {
      console.error(
        "Failed to load create property data:",
        err
      );
  ...
  const handleSaveFaydaVerification = async (e) => {
    ...
    if (!idNumber) {
      setIdError(
        "Please enter your Fayda ID number."
      );
      return;
    }
    ...
    if (!(faydaFrontImage instanceof File)) {
      setIdError(
        "Please upload the front image of your Fayda ID."
      );
      return;
    }
    ...
    if (!(faydaBackImage instanceof File)) {
      setIdError(
        "Please upload the back image of your Fayda ID."
      );
      return;
    }
  ...
  const handlePropertyImagesChange = (e) => {
    ...
    if (selectedFiles.length > 10) {
      setError(
        "You can select a maximum of 10 property photos."
      );
      e.target.value = "";
      return;
    }
    ...
    if (invalidFile) {
      setError(
        "Only JPG, PNG, and WEBP property images are allowed."
      );
      e.target.value = "";
      return;
    }
    ...
    if (largeFile) {
      setError(
        "Each property image must be less than 5MB."
      );
      e.target.value = "";
      return;
    }
  ...
  const handleVideoChange = (e) => {
    ...
    if (file.size > MAX_VIDEO_SIZE) {
      setError(
        "The property tour video must be less than 100MB."
      );
  ...
  const handleOwnershipDocumentChange = (e) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      setError(
        "Only PDF, JPG, PNG, and WEBP ownership documents are allowed."
      );
    ...
    if (file.size > 10 * 1024 * 1024) {
      setError(
        "The ownership document must be less than 10MB."
      );
  ...
  const handleExcelGpsUpload = async (e) => {
    ...
    try {
      ...
      if (
        ...
        setError(
          'Could not find "lat" and "lng" columns in the Excel file.'
        );
      ...
      console.error(
        "Excel GPS import error:",
        err
      );

      setError(
        "Failed to read GPS coordinates from the Excel file. Make sure it is a valid .xlsx or .xls file."
      );
    } finally {
      e.target.value = "";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // STEP 2:
      // Upload property images/video/document
      ...
      // NEW: OWNERSHIP DOCUMENT / MAP PLAN
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border-2 border-black rounded-2xl p-4 bg-slate-50">
                <div className="flex items-center justify-between mb-2">
                  <label className="text-[10px] font-extrabold text-[#022036]">
                    Front Side *
                  </label>
                  ...
                  <div className="space-y-2">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-7 h-7 bg-white/90 hover:bg-white rounded-full flex items-center justify-center text-rose-600 shadow-sm border border-black"
                      >
                        <X size={14} />
                      </button>
                    </div>
    ...
    <div className="min-h-screen w-screen overflow-y-auto bg-white text-slate-800 flex flex-col font-sans">
      ...
      <main className="max-w-4xl mx-auto w-full p-4 sm:p-6 space-y-5 flex-1">
        ...
        <form
          ...
          className="bg-white border-2 border-black p-5 sm:p-7 rounded-2xl shadow-sm space-y-4"
        >

          {/* TITLE */}
          <div>
            <span className="text-[9px] font-extrabold text-yellow-600 uppercase tracking-widest block mb-0.5">
              Teamwork Portal
            </span>

            <h1 className="text-xl font-black text-[#022036]">
          ...
          <fieldset
            ...
            className="space-y-3.5 disabled:opacity-60"
          >
            ...
            <div>
              ...
              {!ownershipDocument ? (
                <div className="border-2 border-dashed border-black hover:border-yellow-500 rounded-xl p-3 transition-colors bg-slate-50">
                  ...
                  <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-[11px] font-bold text-slate-700">
                      Upload Ownership Document / Map Plan
                    </p>
                ...
                <div className="border-2 border-black rounded-xl p-3 bg-emerald-50 flex items-center justify-between gap-3">
                  ...
                  <button
                    type="button"
                    onClick={
                      removeOwnershipDocument
                    }
                    className="shrink-0 w-7 h-7 bg-white hover:bg-slate-100 text-rose-600 rounded-full flex items-center justify-center shadow-sm border-2 border-black"
                  >
                    <X size={13} />
                  </button>
                        ...
                        (
                          ...
                          >
                            <img
                              ...
                              className="w-full h-16 object-cover rounded-lg border-2 border-black"
                            />
                            ...
                            <button
                              ...
                              className="absolute top-1 right-1 w-5 h-5 bg-white/90 hover:bg-white text-rose-600 rounded-full flex items-center justify-center shadow-sm border border-black"
                            >
                              <X size={11} />
                            </button>
                          </div>
                  ...
                  <div className="border-2 border-black rounded-xl p-3 bg-slate-50 space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <video
                        ...
                        controls
                        className="w-full max-h-36 rounded-lg border-2 border-black bg-black"
                      />
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-6 h-6 bg-white/90 hover:bg-white rounded-full flex items-center justify-center text-rose-600 shadow-sm border border-black"
                      >
                        <X size={13} />
                      </button>
                    </div>
