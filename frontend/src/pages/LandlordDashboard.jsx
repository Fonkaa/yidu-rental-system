...
export default function LandlordDashboard() {
  ...
  return (
    <div className="w-full min-h-full px-4 sm:px-10 py-10 flex flex-col gap-8 bg-white font-sans selection:bg-[#FFC107] selection:text-[#022036]">
      ...
      {deleteModalOpen && propertyToDelete && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-[#121212] border border-white/10 rounded-3xl max-w-md w-full p-8 shadow-[0_25px_60px_rgba(0,0,0,0.8)] text-center space-y-6 relative">
            <div className="w-16 h-16 bg-rose-500/10 rounded-full flex items-center justify-center mx-auto text-rose-400 border border-rose-500/20 shadow-inner">
              <Trash2 size={28} />
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <button
                ...
                disabled={processingId === propertyToDelete.id}
                className="flex-1 py-3.5 bg-rose-600 hover:bg-rose-500 text-white font-black rounded-full text-xs shadow-lg transition-all flex items-center justify-center gap-2 uppercase tracking-wider disabled:opacity-50"
              >
                {processingId === propertyToDelete.id ? <Loader size={15} className="animate-spin" /> : null}
      ...
      {!loading && activeTab === 'overview' && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="relative rounded-3xl bg-[#022036] border-2 border-black p-8 sm:p-10 overflow-hidden shadow-2xl text-white group">
          ...
          {/* STAT CARDS - BLACK BORDERS */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            
            <div className="bg-white rounded-3xl border-2 border-black p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)] hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFC107]/5 rounded-bl-full pointer-events-none group-hover:scale-110 transition-transform"></div>
              <div className="flex items-center justify-between mb-4">
                <div className="p-3.5 rounded-2xl bg-[#FFC107]/20 border-2 border-[#FFC107] text-[#FFC107] shadow-inner group-hover:bg-[#FFC107] group-hover:text-[#022036] transition-colors duration-300">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-1">Total Revenue</span>
              ...
              <p className="text-[11px] text-slate-500 mt-2 font-medium">Accumulated earnings</p>
            </div>
            ...
            <div className="bg-white rounded-3xl border-2 border-black p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)] hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="p-3.5 rounded-2xl bg-sky-500/20 border-2 border-sky-500 text-sky-500 shadow-inner group-hover:bg-sky-500 group-hover:text-white transition-colors duration-300">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-1">Volume Settled</span>
              <strong className="text-2xl font-black text-[#022036] font-mono tracking-tight block">
                {financialStats.totalVolume.toLocaleString()} <span className="text-xs font-bold text-slate-400">ETB</span>
              </strong>
              <p className="text-[11px] text-slate-500 mt-2 font-medium">Transaction volume processed</p>
            </div>
            ...
            <div className="bg-white rounded-3xl border-2 border-black p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)] hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="p-3.5 rounded-2xl bg-emerald-500/20 border-2 border-emerald-500 text-emerald-500 shadow-inner group-hover:bg-emerald-500 group-hover:text-white transition-colors duration-300">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-1">Annualized Yield</span>
            ...
            <div className="bg-white rounded-3xl border-2 border-black p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)] hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="p-3.5 rounded-2xl bg-purple-500/20 border-2 border-purple-500 text-purple-500 shadow-inner group-hover:bg-purple-500 group-hover:text-white transition-colors duration-300">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block mb-1">Portfolio Value</span>
              <strong className="text-2xl font-black text-[#022036] font-mono tracking-tight block">
          ...
          {/* CHART & ACTIVITY - BLACK BORDERS */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            <div className="lg:col-span-2 bg-white border-2 border-black rounded-3xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex flex-col justify-between space-y-6">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-base font-black text-[#022036] uppercase tracking-wider flex items-center gap-2">
                    <Sparkles size={18} className="text-[#FFC107]" /> Asset Distribution
                  </h3>
                  <span className="px-3 py-1 bg-[#FFC107]/10 border-2 border-black text-[#022036] rounded-xl text-xs font-black font-mono">{properties.length} Total Units</span>
                </div>
                <p className="text-xs text-slate-500 font-light">Proportional visualization of your real estate inventory status.</p>
              </div>

              <div className="space-y-4">
                <div className="h-5 w-full bg-[#FFC107]/10 rounded-2xl overflow-hidden flex shadow-inner p-1 gap-1 border border-black/10">
                  {properties.length > 0 ? (
                    <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                  {[
                    { label: 'Approved', count: groupedProperties.APPROVED.length, color: 'emerald', bg: 'bg-emerald-50', border: 'border-emerald-200', dot: 'bg-emerald-500' },
                    { label: 'Rented', count: groupedProperties.RENTED.length, color: 'sky', bg: 'bg-sky-50', border: 'border-sky-200', dot: 'bg-sky-500' },
                    { label: 'Pending', count: groupedProperties.PENDING.length, color: 'amber', bg: 'bg-amber-50', border: 'border-amber-200', dot: 'bg-amber-500' },
                    { label: 'Unavailable', count: groupedProperties.UNAVAILABLE.length, color: 'slate', bg: 'bg-slate-50', border: 'border-slate-200', dot: 'bg-slate-400' },
                    { label: 'Expired', count: groupedProperties.EXPIRED.length, color: 'orange', bg: 'bg-orange-50', border: 'border-orange-200', dot: 'bg-orange-500' },
                    { label: 'Rejected', count: groupedProperties.REJECTED.length, color: 'rose', bg: 'bg-rose-50', border: 'border-rose-200', dot: 'bg-rose-500' },
                  ].map((item, idx) => (
                    <div key={idx} className={`flex items-center gap-2.5 p-3 rounded-2xl ${item.bg} border-2 border-black`}>
                      <span className={`w-3 h-3 rounded-lg ${item.dot} shadow-xs`}></span>
                      <div>
                        <span className="text-[10px] uppercase font-bold text-slate-500 block">{item.label}</span>
                        <strong className={`text-xs font-black text-${item.color}-800 font-mono`}>{item.count} Units</strong>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-white border-2 border-black rounded-3xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <Activity size={18} className="text-[#FFC107]" />
                  <h3 className="text-sm font-black text-[#022036] uppercase tracking-wider">Recent Activity</h3>
                </div>
                ...
                {recentActivities.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {recentActivities.map((act, idx) => (
                      <div key={idx} className="p-3.5 bg-slate-50 hover:bg-[#FFC107]/10 border-2 border-black rounded-2xl flex items-start gap-3 transition-colors">
                        <div className={`w-8 h-8 rounded-xl flex items-center justify-center font-bold flex-shrink-0 mt-0.5 shadow-xs border-2 border-black ${act.type === 'message' ? 'bg-sky-50 text-sky-700' : 'bg-amber-50 text-amber-700'}`}>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <span className="text-[9px] text-[#FFC107] font-bold block mt-1 font-mono">{act.time}</span>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <button 
                ...
                className="w-full mt-6 py-3 bg-[#022036] hover:bg-[#FFC107] text-white hover:text-[#022036] rounded-2xl text-xs font-black transition-all flex items-center justify-center gap-2 shadow-md uppercase tracking-wider border-2 border-black"
              >
      ...
      {!loading && activeTab === 'properties' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex justify-between items-center pb-4 border-b-2 border-black">
            ...
            <Link to="/landlord/properties/new" className="px-5 py-3 bg-[#FFC107] hover:bg-yellow-400 text-[#022036] font-extrabold rounded-2xl text-xs shadow-lg flex items-center gap-2 transition-all hover:scale-105 border-2 border-black uppercase tracking-wider">
          ...
          {properties.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center py-28 px-6 bg-white border-2 border-black rounded-3xl shadow-sm">
              <Building2 size={44} className="text-[#FFC107] mb-4" />
              ...
              <Link to="/landlord/properties/new" className="px-6 py-3 bg-[#FFC107] text-[#022036] font-extrabold text-xs rounded-2xl shadow-md uppercase tracking-wider border-2 border-black">Create Listing</Link>
            </div>
          ) : (
              ...
              return (
                <div key={statusKey} className="space-y-4">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 rounded-xl bg-[#022036] text-[#FFC107] border-2 border-black">
                      <StatusIcon size={16} />
                    </div>
                    <h3 className="text-xs font-black uppercase tracking-wider text-[#022036]">{config.label}</h3>
                    <span className="px-2.5 py-0.5 rounded-full bg-[#FFC107]/20 text-[#022036] text-[10px] font-black border-2 border-black">{items.length}</span>
                  </div>

                  <div className="grid grid-cols-1 gap-4">
                    {items.map((p) => (
                      <div key={p.id} className="bg-white border-2 border-black rounded-3xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-[0_10px_30px_rgba(0,0,0,0.02)] hover:shadow-xl transition-all duration-300 group">
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-3 flex-wrap">
                            <h4 className="font-black text-[#022036] text-lg tracking-tight group-hover:text-[#FFC107] transition-colors">{p.titleEn || p.titleAm || 'Untitled Property'}</h4>
                            <span className={`text-[10px] px-3 py-1 rounded-full font-black uppercase tracking-wider ${config.badge}`}>{p.status}</span>
                          </div>
                          <p className="text-xs text-[#FFC107] font-bold flex items-center gap-1.5 font-mono">
                          ...
                          {p.status === 'REJECTED' && (
                            <div className="mt-3 p-3.5 bg-rose-50 border-2 border-black rounded-2xl text-xs text-rose-800 font-medium flex items-start gap-2">
                        ...
                        <div className="flex items-center gap-3 flex-wrap w-full md:w-auto justify-end">
                          <button 
                            ...
                            className="px-4 py-2.5 bg-sky-50 hover:bg-sky-100 text-sky-700 border-2 border-black rounded-2xl text-xs font-extrabold transition-all flex items-center gap-2 shadow-xs"
                          >
                            <Edit3 size={15} />
                            <span>Edit</span>
                          </button>
                          ...
                          {p.status === 'APPROVED' && (
                            <>
                              <button onClick={() => handleMarkRented(p.id)} disabled={processingId === p.id} className="px-4 py-2.5 bg-yellow-50 hover:bg-yellow-100 text-yellow-900 border-2 border-black rounded-2xl text-xs font-extrabold transition-all disabled:opacity-50 shadow-xs">
                                Mark Rented
                              </button>
                              <button onClick={() => handleMarkUnavailable(p.id)} disabled={processingId === p.id} className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 border-2 border-black rounded-2xl text-xs font-extrabold transition-all disabled:opacity-50 shadow-xs">
                                Unavailable
                              </button>
                            </>
                          )}
                          {p.status === 'EXPIRED' && (
                            <button onClick={() => handleRenew(p.id)} disabled={processingId === p.id} className="px-5 py-2.5 bg-[#FFC107] text-[#022036] rounded-2xl text-xs font-black transition-all shadow-md uppercase tracking-wider border-2 border-black disabled:opacity-50">
                              Renew
                            </button>
                          )}
                          <Link to={`/landlord/properties/${p.id}`} className="px-4 py-2.5 bg-[#022036] hover:bg-[#FFC107] text-white hover:text-[#022036] rounded-2xl text-xs font-extrabold flex items-center gap-1.5 shadow-md border-2 border-black transition-all">
                          ...
                          <button
                            ...
                            className="p-2.5 bg-[#022036] hover:bg-rose-600 text-white rounded-2xl transition-all flex items-center justify-center shadow-xs border-2 border-black disabled:opacity-50"
      ...
      {!loading && activeTab === 'edit-property' && selectedProperty && (
        <div className="space-y-6 max-w-3xl mx-auto w-full bg-white border-2 border-black rounded-3xl p-8 sm:p-10 shadow-2xl animate-in fade-in duration-300">
          <div className="flex items-center justify-between pb-6 border-b-2 border-black">
            <div>
              <h3 className="text-xl font-black text-[#022036] flex items-center gap-2.5">
                <Edit3 className="text-[#FFC107]" size={24} /> Edit Property & Manage Photos
              </h3>
              <p className="text-xs text-slate-500 mt-1 font-light">
                Update specifications and imagery for <strong className="text-[#022036] font-bold">{selectedProperty.titleEn || "Property"}</strong>.
              </p>
            </div>
            <button
              onClick={() => setActiveTab('properties')}
              className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-2xl text-xs font-bold border-2 border-black transition-all"
            >
              Cancel
            </button>
          </div>
          ...
          {editFeedback && (
            <div className={`p-4 rounded-2xl text-xs flex items-center gap-2 border-2 border-black font-medium ${editFeedback.type === 'success' ? 'bg-emerald-50 text-emerald-800' : 'bg-rose-50 text-rose-800'}`}>
          ...
          <form onSubmit={handlePropertyUpdateSubmit} className="space-y-6">
            ...
            <div className="bg-[#FFC107]/5 border-2 border-black rounded-3xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white border-2 border-black rounded-2xl px-4 py-3.5 text-slate-900 focus:outline-none focus:border-[#FFC107] font-medium shadow-inner"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleEditChange}
                    required
                    className="w-full bg-white border-2 border-black rounded-2xl px-4 py-3.5 text-slate-900 focus:outline-none focus:border-[#FFC107] font-mono shadow-inner font-bold"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleEditChange}
                    className="w-full bg-white border-2 border-black rounded-2xl px-4 py-3.5 text-slate-900 focus:outline-none focus:border-[#FFC107] shadow-inner"
                  />
                </div>
                ...
                <div className="flex items-center gap-2.5 pt-2">
                  <input
                    ...
                    onChange={handleEditChange}
                    className="w-5 h-5 accent-[#FFC107] rounded-lg border-2 border-black"
                  />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {selectedProperty.images && selectedProperty.images.length > 0 ? (
                  selectedProperty.images.map((img) => (
                    <div key={img.id} className="relative h-24 rounded-2xl overflow-hidden border-2 border-black bg-slate-200 shadow-sm">
                      <img
              ...
              <div className="pt-4 border-t-2 border-black space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs text-slate-600 file:mr-4 file:py-3 file:px-5 file:rounded-2xl file:border-0 file:text-xs file:font-black file:bg-[#FFC107] file:text-[#022036] hover:file:bg-yellow-400 file:cursor-pointer cursor-pointer border-2 border-black"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs text-slate-600 file:mr-4 file:py-3 file:px-5 file:rounded-2xl file:border-0 file:text-xs file:font-black file:bg-slate-200 file:text-slate-700 hover:file:bg-slate-300 file:cursor-pointer cursor-pointer border-2 border-black"
                  />
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-[#FFC107] hover:bg-yellow-400 text-[#022036] font-black rounded-2xl text-xs uppercase tracking-wider shadow-lg transition-all flex items-center justify-center gap-2 border-2 border-black disabled:opacity-50"
            >
      ...
      {!loading && activeTab === 'requests' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {rentalRequests.length === 0 ? (
            <div className="p-16 text-center bg-white border-2 border-black rounded-3xl shadow-sm">
              <FileText size={40} className="text-[#FFC107] mx-auto mb-3" />
              <p className="text-xs text-slate-500 font-light">No rental requests received yet.</p>
            </div>
          ) : (
            <div className="space-y-4">
              {rentalRequests.map((req) => (
                <div key={req.id} className="bg-white border-2 border-black rounded-3xl p-6 sm:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.02)] hover:shadow-xl transition-all space-y-4">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <button onClick={() => navigate(`/landlord/messages/${req.tenantId}`)} className="px-4 py-2.5 bg-slate-100 hover:bg-[#FFC107] hover:text-[#022036] text-slate-800 rounded-2xl text-xs font-extrabold flex items-center gap-2 transition-all shadow-xs border-2 border-black">
                        <MessageSquare size={15} /> Message
                      </button>
                      <span className={`px-3.5 py-1.5 rounded-full text-xs font-black uppercase tracking-wider border-2 border-black ${req.status === 'APPROVED' ? 'bg-emerald-50 text-emerald-700' : req.status === 'REJECTED' ? 'bg-rose-50 text-rose-700' : 'bg-amber-50 text-amber-800'}`}>
                        {req.status}
                      </span>
                    </div>
                  </div>

                  <p className="text-xs text-slate-700 bg-slate-50 border-2 border-black p-4 rounded-2xl font-medium leading-relaxed">
                    <strong className="text-slate-900 block mb-1 font-bold">Tenant Note:</strong> {req.message || "No custom message provided"}
                  </p>

                  {req.status === 'PENDING' && (
                    <div className="flex gap-3 pt-2">
                      <button onClick={() => handleRequestStatusUpdate(req.id, 'REJECTED')} disabled={processingId === req.id} className="flex-1 py-3 bg-rose-50 hover:bg-rose-100 text-rose-700 border-2 border-black rounded-2xl text-xs font-black transition-all shadow-xs disabled:opacity-50">
                        Reject
                      </button>
                      <button onClick={() => handleRequestStatusUpdate(req.id, 'APPROVED')} disabled={processingId === req.id} className="flex-1 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-xs font-black transition-all shadow-md uppercase tracking-wider border-2 border-black disabled:opacity-50">
                        Approve
                      </button>
                    </div>
                  )}
          ...
          {rentalHistory.length === 0 ? (
            ...
            <div className="space-y-4">
              {rentalHistory.map((req) => (
                <div key={req.id} className="bg-white border-2 border-black rounded-3xl p-6 sm:p-7 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    <h4 className="font-extrabold text-[#022036] text-base">{req.property?.titleEn || req.property?.title || "Property"}</h4>
                    <p className="text-xs text-slate-500 mt-1 font-medium">
                      Tenant: <span className="text-slate-900 font-bold">{req.tenant?.fullName}</span> • Rent: <span className="text-[#FFC107] font-mono font-black">{req.proposedPrice || req.property?.price} ETB</span>
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
                    <button onClick={() => navigate(`/landlord/messages/${req.tenantId}`)} className="p-2.5 bg-slate-100 hover:bg-[#FFC107] hover:text-[#022036] text-slate-700 rounded-2xl transition-all shadow-xs border-2 border-black" title="Open Chat">
                      <MessageSquare size={16} />
                    </button>
                    <span className="px-3.5 py-1.5 bg-emerald-50 border-2 border-black text-emerald-700 text-xs rounded-full font-black uppercase tracking-wider">
                      {req.status}
                    </span>
                  </div>
                </div>
      ...
      {!loading && activeTab === 'messages' && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {conversations.length === 0 ? (
            <div className="p-20 text-center bg-white border-2 border-black rounded-3xl shadow-sm">
              <MessageSquare size={44} className="text-[#FFC107] mx-auto mb-3" />
            ...
            <div className="bg-white border-2 border-black rounded-3xl overflow-hidden divide-y-2 divide-black shadow-sm">
              {conversations.map((chat) => (
                <div
                  key={chat.contactId}
                  onClick={() => navigate(`/landlord/messages/${chat.contactId}`)}
                  className="flex items-center justify-between p-6 hover:bg-[#FFC107]/5 transition-all cursor-pointer group"
                >
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="w-14 h-14 rounded-2xl bg-[#FFC107]/20 text-[#FFC107] border-2 border-black flex items-center justify-center font-bold flex-shrink-0 group-hover:scale-105 transition-transform shadow-xs">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2.5">
                        ...
                        {chat.unread && (
                          <span className="w-2.5 h-2.5 rounded-full bg-[#FFC107] animate-pulse shadow-xs"></span>
                        )}
                      </div>
                      {chat.property && (
                        <span className="text-[10px] uppercase font-black text-[#FFC107] block mt-0.5 tracking-wider">
                  ...
                  <div className="flex items-center gap-4 flex-shrink-0">
                    ...
                    <div className="w-9 h-9 rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:text-[#022036] group-hover:bg-[#FFC107] transition-all shadow-xs border-2 border-black">
      ...
      {/* ============================================================
          TAB: SETTINGS — PROFESSIONAL PROFILE
      ============================================================ */}
      {!loading && activeTab === 'settings' && (
        <div className="space-y-6 max-w-2xl mx-auto w-full bg-white border-2 border-black rounded-3xl p-8 sm:p-10 shadow-2xl animate-in fade-in duration-300">
          
          {/* HEADER */}
          <div className="flex items-center justify-between pb-6 border-b-2 border-black">
            <div>
              <h3 className="text-xl font-black text-[#022036] flex items-center gap-2.5">
                <SettingsIcon className="text-[#FFC107]" size={24} /> Profile & Security Settings
              </h3>
              <p className="text-xs text-slate-500 mt-1 font-light">
                Manage personal credentials and password security.
              </p>
            </div>
            <button
              type="button"
              onClick={handleCancelSettings}
              className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-2xl text-xs font-bold border-2 border-black transition-all flex items-center gap-1.5"
            >
              <X size={14} /> Cancel
            </button>
          </div>
          ...
          {/* FEEDBACK */}
          {settingsFeedback && (
            <div className={`p-4 rounded-2xl text-xs flex items-center gap-2 border-2 border-black font-medium ${settingsFeedback.type === 'success' ? 'bg-emerald-50 text-emerald-800' : 'bg-rose-50 text-rose-800'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className="w-full bg-slate-100 border-2 border-black rounded-2xl px-4 py-3.5 text-slate-400 cursor-not-allowed font-medium shadow-inner"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleSettingsChange}
                    placeholder="+251 9..."
                    className="w-full bg-white border-2 border-black rounded-2xl px-4 py-3.5 text-slate-900 focus:outline-none focus:border-[#FFC107] font-mono shadow-inner"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FFC107]/5 border-2 border-black rounded-3xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 text-xs">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleSettingsChange}
                      placeholder="••••••••"
                      className="w-full bg-white border-2 border-black rounded-2xl px-4 py-3.5 pr-12 text-slate-900 focus:outline-none focus:border-[#FFC107] font-mono shadow-inner"
                    />
                    <button
                      type="button"
                      onClick={() => setShowCurrentPassword(!showCurrentPassword)}
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#FFC107]"
                    >
                ...
                <div>
                  ...
                  {settingsForm.confirmPassword && settingsForm.newPassword && settingsForm.confirmPassword !== settingsForm.newPassword && (
                    <div className="mt-1.5 flex items-center gap-1.5 text-rose-600">
                      <AlertCircle size={12} />
                      <span className="text-[11px] font-bold">Passwords do not match!</span>
                    </div>
                  )}
                  {settingsForm.confirmPassword && settingsForm.newPassword && settingsForm.confirmPassword === settingsForm.newPassword && (
                    <div className="mt-1.5 flex items-center gap-1.5 text-emerald-600">
                      <CheckCircle2 size={12} />
                      <span className="text-[11px] font-bold">Passwords match</span>
                    </div>
                  )}
                </div>
              </div>
