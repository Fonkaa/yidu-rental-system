        ...
        <div className="w-[380px] sm:w-[420px] h-[640px] bg-white border-2 border-black rounded-3xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="px-5 py-4 bg-[#022036] border-b-2 border-black flex items-center justify-between text-white flex-shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <strong className="text-xs tracking-wider uppercase text-[#FFC107]">
                Hose Rental system
              </strong>
            </div>
            ...
            <button
              ...
              className="p-1 text-white hover:bg-white/20 rounded-lg cursor-pointer border-2 border-transparent hover:border-white/20"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3.5 bg-slate-50 scrollbar-thin scrollbar-thumb-slate-200">
            {messages.map((msg, index) => (
              ...
              >
                <div
                  className={`max-w-[85%] p-3.5 rounded-2xl text-xs leading-relaxed border-2 border-black ${
                    msg.sender === "user"
                      ? "bg-[#FFC107] text-[#022036] font-bold rounded-br-sm"
                      : "bg-white text-slate-800 rounded-bl-sm shadow-xs font-medium"
                  }`}
                >
                  {msg.text}
                </div>
            ...
            <div className="max-h-40 overflow-y-auto space-y-1.5 pr-1 scrollbar-thin scrollbar-thumb-slate-300">
              {tenantQuestionsAndAnswers.map((item, idx) => (
                ...
                >
                  ...
                  <span className="text-[10px] text-amber-600 font-bold opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 ml-2">
                    Get Answer →
                  </span>
                </button>
              ))}
          ...
          <form
            onSubmit={handleSend}
            className="p-3 bg-white border-t-2 border-black flex items-center gap-2 flex-shrink-0"
          >
            <input
              type="text"
            ...
            <button
              type="submit"
              className="p-2 bg-[#FFC107] hover:bg-[#ffcd38] text-[#022036] rounded-xl font-bold cursor-pointer border-2 border-black"
            >
              <Send size={16} />
            </button>
          </form>
    ...
    <div className="h-screen w-screen overflow-hidden bg-slate-100 text-slate-800 flex font-sans selection:bg-[#FFC107] selection:text-[#022036]">
      ...
      >
        <div className="overflow-y-auto pr-1 scrollbar-thin">
          <div
            className="hidden lg:flex items-center gap-3 mb-6 cursor-pointer px-2"
          ...
          >
            ...
            <div className="flex flex-col">
              <strong className="text-base tracking-tight leading-tight text-white">
                Hose Rental system
              </strong>
          ...
          <div className="flex items-center gap-3 p-3 bg-[#0B2C45] border-2 border-black rounded-2xl mb-8 shadow-md">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-[10px] bg-[#FFC107] text-[#022036] font-black px-1.5 py-0.5 rounded uppercase tracking-wider w-fit mt-0.5 border border-black">
                TENANT
              </span>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      className={
                        isActive ? "text-[#022036]" : "text-[#FFC107]"
                      }
                    >
                      {item.icon}
                    </span>
                ...
                {showLanguageDropdown && (
                  <div className="absolute right-0 mt-2 w-36 bg-[#022036] border-2 border-black rounded-2xl shadow-2xl py-2 z-50">
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-xs text-white/80 hover:bg-white/5 border-b border-white/10"
                    >
                      🇪🇹 አማርኛ
                    </button>
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-xs text-white/80 hover:bg-white/5"
                    >
                      🇬🇧 English
                    </button>
                  </div>
